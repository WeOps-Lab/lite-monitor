...
from apps.monitor.views.metrics import MetricObjectVieSet, MetricGroupVieSet, MetricVieSet, DimensionVieSet
...
router.register(r"api/metrics_dimension", DimensionVieSet, basename="MetricsInstance")
