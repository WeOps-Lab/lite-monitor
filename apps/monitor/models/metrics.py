...
class MetricObject(TimeInfo, MaintainerInfo):
    name = models.CharField(unique=True, max_length=100, verbose_name='指标对象名称')
...
class MetricGroup(TimeInfo, MaintainerInfo):
    metric_object = models.ForeignKey(MetricObject, on_delete=models.CASCADE, verbose_name='指标对象')
